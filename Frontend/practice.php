...
<body>
	...
	<div class="container pt-20 px-20 xl:px-60">
		<div class="flex flex-col justify-center items-center">
			...
			<div class="relative w-full mt-12">
				<div class="absolute left-0 top-0 border-r border-b border-black py-1 px-4 text-sm inline-flex items-center space-x-1">
					<div class="pb-0.5">
	...
	<div class="absolute inset-0 flex justify-center items-center bg-gray-400 bg-opacity-60" id="start-modal">
		<div class="bg-white rounded-md bg-opacity-100 z-50 px-28 py-16 flex justify-center flex-col items-center">
			...
			<button class="bg-black py-1 px-6 text-white text-center mt-4 rounded-sm" id="start-button">
				Start
			</button>
		</div>
	</div>
	...
	<div class="absolute inset-0 flex justify-center items-center bg-gray-400 bg-opacity-60 hidden" id="result-modal">
		<div class="bg-white rounded-md bg-opacity-100 z-50 px-28 py-16 flex justify-center flex-col items-center">
			...
			<button class="bg-black py-1 px-6 text-white text-center mt-4 rounded-sm" id="tryagain-button">
				Try again
			</button>
		</div>
	</div>
